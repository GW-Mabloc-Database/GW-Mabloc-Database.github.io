...
if (mysqli_num_rows($result) > 0) {
  ...
  $fields = array("Specimen", "Species", "Initials", "Experiment", "Site", "Visit", "Celltype", "Cellnumber", "Sampledate", "Room", "Freezer", "Cane", "Box", "Row_", "Column_", "WrittenonTube_Notes","RemovedfromBoxforELISAfridge?", "IgG_Spike", "IgG_SpikeValue", "Counter", "IgGTitration");
